...
R0_fit_plt_fn = "results/covid19_weather/us_state_R0_fit_plot_Wang.pdf"  # Wang: plot
...
min_count = 1                             # Wang: starts from the first-case date
min_day = 5
min_cases = 40                            # Wang: each state must have min 40 cases
covid19_generation_time_mean = 7.4        # Wang: serial interval distribution      
covid19_generation_time_sd = 5.2          # Wang: serial interval distribution
covid19_generation_time_dist = "weibull"  # Wang: serial interval distribution
R0_fit_fn = "data/processed/us_state_R0_fit_wang.txt"  # Wang: fitted file
...
# Wang: each state must have at least 40 [min_cases] cases on 3/20/2020
state_cases_df = state_cases_df[state_cases_df$`3/20/2020` >= min_cases, ]

# Wang: no requirement for number of days
